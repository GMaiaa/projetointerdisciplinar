...
- Yuri Takamisawa
##### Instalação
O projeto esta em desenvolvimento utilizando React, a linguagem Java 17 e o framework Spring Boot.
...
- A classe QuitandafrescorApplication inicializa a execução do projeto
